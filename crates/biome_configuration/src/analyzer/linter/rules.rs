...
impl RuleName {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::NoSvelteUninitializedStore => "noSvelteUninitializedStore",
    ...
    pub const fn group(self) -> RuleGroup {
        match self {
            ...
            Self::NoDuplicateDependencies => RuleGroup::Nursery,
            ...
            Self::NoReactForwardRef => RuleGroup::Nursery,
            ...
            Self::NoSvelteUninitializedStore => RuleGroup::Nursery,
            ...
            Self::NoUnusedExpressions => RuleGroup::Nursery,
            ...
            Self::NoUselessCatchBinding => RuleGroup::Nursery,
            ...
            Self::UseConsistentArrowReturn => RuleGroup::Nursery,
            ...
            Self::UseDeprecatedDate => RuleGroup::Nursery,
            ...
            Self::UseQwikValidLexicalScope => RuleGroup::Nursery,
...
impl std::str::FromStr for RuleName {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "noSvelteUninitializedStore" => Ok(Self::NoSvelteUninitializedStore),
...
impl RuleGroupExt for Nursery {
    ...
    fn get_enabled_rules(&self) -> FxHashSet<RuleFilter<'static>> {
        ...
        if let Some(rule) = self.no_svelte_uninitialized_store.as_ref()
            && rule.is_enabled()
        {
            index_set.insert(RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[12]));
        }
    ...
    fn get_rule_configuration(
        ...
        match rule_name {
            ...
            "noShadow" => self
                ...
                .as_ref()
                .map(|conf| (conf.level(), conf.get_options())),
            "noSvelteUninitializedStore" => self
                .no_svelte_uninitialized_store
                .as_ref()
                .map(|conf| (conf.level(), conf.get_options())),
            ...
            "noUnresolvedImports" => self
                ...
                .as_ref()
                .map(|conf| (conf.level(), conf.get_options())),
            "noUnusedExpressions" => self
                .no_unused_expressions
                .as_ref()
                .map(|conf| (conf.level(), conf.get_options())),
            "noUselessCatchBinding" => self
                .no_useless_catch_binding
                .as_ref()
                .map(|conf| (conf.level(), conf.get_options())),
            ...
            "useQwikClasslist" => self
                ...
                .as_ref()
                .map(|conf| (conf.level(), conf.get_options())),
            "useQwikMethodUsage" => self
                .use_qwik_method_usage
                .as_ref()
                .map(|conf| (conf.level(), conf.get_options())),
            "useQwikValidLexicalScope" => self
...
impl From<GroupPlainConfiguration> for Nursery {
    fn from(value: GroupPlainConfiguration) -> Self {
        Self {
            ...
            use_qwik_method_usage: Some(value.into()),
